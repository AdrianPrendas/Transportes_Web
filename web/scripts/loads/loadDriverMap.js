...
view = {
	updateNav: function(driver){//actualizando el boton de estado
		if(driver.vehiculo.estado){
			$("#offPic").css("display","none");
			$("#onPic").css("display","block");
		}
		else{
			$("#offPic").css("display","block");
			$("#onPic").css("display","none");
		}
	}
};

$(document).ready(function(){
	$("#mapItem").css("display","none");//ocultando link al mapa

	userController = new UserController();
	model = new Model();

	view.updateNav(userController.getUser());
...
function initMap() {
    ...
    $(function(){
    	$("#estado").on("click",function(){
    		var driver = userController.getUser();
    		Proxy.getConductorId(driver.usuarioIdUsuario,function(driverUpdated){
    			...
    			view.updateNav(driverUpdated);
    			userController.storeUser(driverUpdated);
    			Proxy.editConductor(driverUpdated,undefined);
    		})
    	})
    });
}
